...
<head>
    <title>Add Employee | Artisan Aid</title>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <p>Joining Date</p>
                        <div class="input-group">
                            <input class="input--style-1" type="date" placeholder="Joining Date" name="joindate" required="required">
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Designation" name="designation" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Salary" name="salary" required="required">
                        </div>
